...
| `03-platform-authority` | `00-market-browse-install` | `invocation-resolution.md`, `agent-runtime.md`, `interfaces.md`, `permissions.md`, Rust domain identities | `AGENT-*`, `MARKET-*`, `RUNTIME-*` |
