...
| `M00 Platform Control/Identity` | `platform-identity.md`, `platform-session.md`, `platform-session-port.md`, `platform-request-context.md`, `B-M00-M10-ACTOR` | cross-feature admission only; B4a session-port plus secure durable DemoReviewed current-session read/bootstrap vendor are bounded implemented, while B4b control-evidence and B5 M10 administration remain planned | `active:AUTH-011`; `active:AUTH-012`; `active:AUTH-013`; `active:AUTH-014`; `active:AUTH-015`; `active:AUTH-016`; `active:AUTH-017`; `active:AUTH-018`; `active:AUTH-019`; `active:AUTH-020`; `active:AUTH-021` |
