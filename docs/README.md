...
For the runnable competition slice, begin with [`features/06-mvp-core-capabilities.md`](features/06-mvp-core-capabilities.md) and [`contracts/agent-chat.md`](contracts/agent-chat.md).
