...
- round-7 repair（2026-08-06，仅 16B prototype；checker/tests/CI 冻结未动）：**edge hardening**——`.row .meta`/`.note`/`.warn`/`.ok`/`label.ck .meta` 增加 `overflow-wrap:anywhere`；320px 注入 600 字符 ASCII 极端值实测无横向溢出（注入 12 屏 S01/S05/S06/S06a/S07/S07a/S08/S09/S10/S11a/S12/S13 + S12-confirmed/S11-stale 两分支 = 14 组全过；S02/S03/S04 与 S11 正常分支无长文本注入目标，未注入）；round-8.2 扩展至 `ul.clean li`/`ul.clean .meta`/`.demo`（S01 安装流演示入口区与 S10/S13 列表 meta），17 组全过；不动 PR body。
