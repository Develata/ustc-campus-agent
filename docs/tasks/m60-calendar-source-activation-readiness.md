...
- `Stage`: `PROPOSAL_ONLY_R49_REVIEWED_RECEIPT_BOUND`
...
- `Packet digest`: `sha256:7056566a2fa414257108f5bdd2d317eea6f49f054995d4105b602b23666784df` over `156422` bytes beginning immediately after the packet `BEGIN` marker newline and ending immediately before the `END` marker token, including the final packet newline
- `Candidate generation`: `R49`
