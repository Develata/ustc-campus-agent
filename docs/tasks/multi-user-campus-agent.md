...
| Calendar | Propose dated action in Chat; confirm; create/read/change/delete own item; reliable duplicate suppression and reminders | Durable owner-local record/list/delete; tenant scope, update, confirmation lifecycle and reminders planned |
...
| C1 | Calendar owner-scoped command/query and exact-effect confirmation | Owning Calendar contract update and controlled admitted context; A3 for real ingress | Planned; A/B isolation, duplicate-write and restart evidence |
