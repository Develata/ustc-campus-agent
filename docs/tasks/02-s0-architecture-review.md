...
| `S0-M80` | Dioxus Fullstack Multi-client | `Accept` | `architecture`; `authority`; `delivery` | Own shared Web/PWA/Android routes, components and presentation state; all product calculations and mutations remain backend-owned. | — | — | — | `closed` |
