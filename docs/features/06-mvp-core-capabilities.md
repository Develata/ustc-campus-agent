...
| 记录个人事项 | 记录、列出、日期安排、修改与删除；确认写入后重启可回读 | 保留原显式指令；日期新增、修改和删除可先创建服务端提案，再由用户确认。没有提醒投递或同步 |
...
| 实用性 | 功能完整性与解决方案有效性 | 可核对办理步骤、解释课程约束、记录并回读事项；[任务录像](../guides/competition-demo.md#录像顺序)展示结果，日期提案及确认已接通，提醒投递仍缺失 |
