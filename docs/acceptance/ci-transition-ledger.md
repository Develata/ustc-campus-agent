...
|---|---|---|---|---|---|
| `CI-TR-001` | active workflow exact digest remains frozen | `.github/workflows/ci.yml` SHA-256 `919080325ade109dab32b556cbc97fb3fcd5844e45ad72e3b74ad231cb669146` | `scripts/tests/fixtures/ci-v2.yml` inert fixture SHA-256 `5ade8421716bc39d11cf6d070884fd56b6d8928eb1caf4957711b5af8c6be675` | `scripts/check_repo_contracts.py` pins both digests; mutation tests remove/mutate each independently | `inert-not-active` |
...
| `CI-TR-006` | repository checker remains an exact executable command after the full checker suite | `.github/workflows/ci.yml` `docs-and-contracts` job runs `python3 scripts/check_repo_contracts.py` | `scripts/tests/fixtures/ci-v2.yml` runs `python3 scripts/check_repo_contracts.py` exactly once after the shard runner | `scripts/check_repo_contracts.py` validates checker command presence and count in fixture; mutation tests remove/duplicate the command | `inert-not-active` |
