...
| `M71` | USTC Affairs Navigator | `partial-evidence` | reviewed tree/procedure artifacts, lookup, supersession and publication journey | generic source authority, full-corpus RAG as truth | hardened ProcedureDraft/artifact/policy/freshness/conflict kernel plus fixture-backed exact stable-ID product composition; real source import, administrator review/publish, structured search, supersession and Web journey remain planned |
